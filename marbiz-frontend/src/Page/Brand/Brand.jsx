    ...
    return (
        <div>
            <Container className='py-5'>
                ...
                <Row className='d-grid align-content-center justify-content-center' style={{
                    ...
                    <div className="d-flex justify-content-center flex-column align-items-center">
                        ...
                        <p className='text-secondary text-center fs-4 text-capitalize my-3'>Find influencer, run campaigns, and get unique content for your brand in seconds</p>
                    </div>
            ...
            <InfoCardOne
                ...
                infoboxSubtitleOne={"Search thousands of vetted Instagram, UGC, and YouTube influencers."}
                infoboxHeadingTwo={"Purchase Securely"}
                infoboxSubtitleTwo={"Safely purchase through Marbiz. We hold your payment until the work is completed."}
                infoboxHeadingThree={"Receive Quality Content"}
                infoboxSubtitleThree={"Receive your high-quality content from influencers directly through the platform."}
            />
            ...
            <InfoCardTwo
                ...
                infoboxSubtitleOne={"Centralize your images, requirements, content examples, and more in a campaign brief."}
                infoboxHeadingTwo={"Get Brand Deals"}
                infoboxSubtitleTwo={"Get discovered by thousands of brands on our marketplace looking to work with you."}
                infoboxHeadingThree={"Get Brand Deals"}
                infoboxSubtitleThree={"Get discovered by thousands of brands on our marketplace looking to work with you."}
            />
            ...
            <InfoCardOne
                ...
                infoboxSubtitleTwo={"Specify demographics including niche, location and following size of the influencers you want to target."}
                infoboxHeadingThree={"Influencers Apply"}
                infoboxSubtitleThree={"Targeted influencers apply with their pricing and you can choose who to work with."}
            />
            ...
            <InfoCardTwo
                ...
                infoboxSubtitleOne={"Purchase sponsored content on Instagram, TikTok, and YouTube."}
                infoboxHeadingTwo={"Product Tutorials"}
                infoboxSubtitleTwo={"Use influencers to create high-quality product tutorials."}
                infoboxHeadingThree={"Testimonials"}
                infoboxSubtitleThree={"Get influencers to generate testimonials for your product or business."}
            />
