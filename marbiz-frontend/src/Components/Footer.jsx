...
const Footer = () => {
  return (
    <footer className="footer text-center text-lg-start text-white pt-5">
      <section className="">
        <div className="container text-center text-md-start mt-5">
          ...
          <div className="row mt-3">
            ...
            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
              {/* <!-- Links --> */}
              <h4 className="text-uppercase fw-bold mb-4">Category</h4>
              <p>
            ...
            <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
              {/* <!-- Links --> */}
              <h4 className="text-uppercase fw-bold mb-4">Discover</h4>
              <p>
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p>
                <i className="fas fa-home me-3"></i>Ajmer, Rajasthan
              </p>
              <p>
              ...
              <p>
                <i className="fas fa-phone me-3"></i>+91-8078671648
              </p>
            </div>
          </div>
        </div>
