...
const InfoCardTwo = ({ title, infoboxHeadingOne, infoboxSubtitleOne, image, infoboxHeadingThree, infoboxHeadingTwo, infoboxSubtitleThree, infoboxSubtitleTwo }) => {
    return (
        <div>
            <div className="container pb-md-5">
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="text-white infoCardHeading">
                            {title}
                        </div>
                        <div className="mt-3">
