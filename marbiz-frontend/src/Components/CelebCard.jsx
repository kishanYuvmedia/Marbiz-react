          ...
          <div className="card-footer">
            <div className="media">
              ...
              <div className="media-body">
                <h6 className="my-0 fw-bold text-2xl text-white d-block">
                  Celebrity Name
                </h6>
                <small className="text-white">Active Platform</small>
                <div className="d-flex justify-content-start mt-2">
                  <span class="bg-pink-100 text-pink-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-purple-900 dark:text-purple-300">
                    #New
                  </span>
