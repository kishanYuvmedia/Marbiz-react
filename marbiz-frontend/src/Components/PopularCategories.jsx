...
const PopularCategories = () => {
    const categories = [
        ...
        { name: 'Tv Celeb', color: 'success' },
        { name: 'Celeb', color: 'secondary' },
        { name: 'Celeb', color: 'danger' },
        { name: 'Celeb', color: 'primary' },
    ];
            ...
            <div className="row mt-3 justify-content-start">
                ...
                {categories.map((category, index) => (
                    <div className="d-inline-flex m-2" key={index}>
                        <div className={`btn btn-${category.color} px-3 py-2 fs-6 fw-medium`}>
