...
apiKit.interceptors.request.use(function (request) {
  // console.log("=========================")
  // console.log("REQUEST:")
...
export const axiosRequest = async (
  ...
  if(!_.isEmpty(routeParams)){
    Object.keys(routeParams).forEach(key => {
      if(routeParams[key]) url = updateQueryStringParameter(url, key, routeParams[key]);
    });
  }
  let body;
  ...
  return apiKit.request(queryConfig)
    .then((res) => res.data)
